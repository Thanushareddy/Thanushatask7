...
public class Builder_pattern {
    ...
    private final String address; // optional
	    ...
	    public static void main(String[] args) {
	        Builder_pattern user1 = new Builder_pattern.UserBuilder("preethi", "ria")
	        .age(20)
	        .phone("9868567679")
	        .address("address 9-291a")
	        .build();
	     
	        System.out.println(user1);
	     
	        Builder_pattern user2 = new Builder_pattern.UserBuilder("sweety", "thanu")
	        .age(30)
	        .phone("7877678756")
	        //no address
	        .build();
